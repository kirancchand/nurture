...
class _NotificationsState extends State<Notifications> {
  ...
  void initState() {
    ...
    api.getNotification(controller.text.value).then((notifi) {
      setState(() {
        notification = notifi.response;
      });
    });
  ...
  void onStateChange(state) {
    ...
    api.getNotification(state).then((notifi) {
      setState(() {
        notification = notifi.response;
      });
      hideSpinner();
          ...
          children: [
            ...
            controller.text.value.isEmpty
                ...
                : Container(
                    ...
                    itemBuilder: (context, int index) {
                      // data:response[index]
                      return NotificationList(data: notification[index]);
                    },
                  )),
            // ListView.builder(
            //                itemCount: 5,
